...
final class XmlExportEngine extends BaseExporter implements ExportEngineHandler {

  List<ExcelSpecificDataType> excelSpecificDataTypes;
  List<DataType> dataTypes;

  XmlExportEngine(Options options, String title, List<ColumnInfo> columnsInfo, String dataformat) throws Exception {
